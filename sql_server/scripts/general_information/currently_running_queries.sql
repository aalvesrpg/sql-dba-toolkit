--This query can only be executed in a SQL Server 2012+ or higher environment due to the features we utilize in this query that are provided by Microsoft in these versions.
